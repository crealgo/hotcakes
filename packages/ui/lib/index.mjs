 ...
 */
const O = globalThis, B = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, W = Symbol(), q = /* @__PURE__ */ new WeakMap();
let st = class {
  constructor(t, e, s) {
...
const lt = (r) => new st(typeof r == "string" ? r : r + "", void 0, W), ct = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: ut, getOwnPropertyDescriptor: $t, getOwnPropertyNames: _t, getOwnPropertySymbols: ft, getPrototypeOf: At } = Object, f = globalThis, K = f.trustedTypes, yt = K ? K.emptyScript : "", D = f.reactiveElementPolyfillSupport, b = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? yt : null;
      break;
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[b("elementProperties")] = /* @__PURE__ */ new Map(), g[b("finalized")] = /* @__PURE__ */ new Map(), D == null || D({ ReactiveElement: g }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, M = w.trustedTypes, G = M ? M.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, it = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, rt = "?" + _, mt = `<${rt}>`, m = document, C = () => m.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", nt = Array.isArray, gt = (r) => nt(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, Q = />/g, A = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, ot = /^(?:script|style|textarea|title)$/i, vt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Et = vt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), y = m.createTreeWalker(m, 129);
function ht(r, t) {
...
const St = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); )
      u = n.lastIndex, n === S ? p[1] === "!--" ? n = Z : p[1] !== void 0 ? n = Q : p[2] !== void 0 ? (ot.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? Y : X) : n === Y || n === X ? n = A : n === Z || n === Q ? n = S : (n = A, i = void 0);
    const $ = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + mt : l >= 0 ? (s.push(c), h.slice(0, l) + it + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
...
class x {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = x.createElement(c, s), y.currentNode = this.el.content, e === 2) {
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes())
          for (const l of i.getAttributeNames())
            if (l.endsWith(it)) {
              ...
              h.push({ type: 1, index: o, name: H[2], strings: $, ctor: H[1] === "." ? wt : H[1] === "?" ? Pt : H[1] === "@" ? Ct : k }), i.removeAttribute(l);
            } else
        ...
        if (ot.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++)
              i.append(l[$], C()), y.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[u], C());
          }
        }
...
class bt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new T(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new Ut(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class T {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : gt(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  k(t) {
    ...
    let s, i = 0;
    for (const o of t)
      i === e.length ? e.push(s = new T(this.S(C()), this.S(C()), this, this.options)) : s = e[i], s._$AI(o), i++;
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0)
      t = E(this, t, e, 0), n = !U(t) || t !== this._$AH && t !== v, n && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++)
        c = E(this, a[s + h], e, h), c === v && (c = this._$AH[h]), n || (n = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
z == null || z(x, T), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.1.4");
const xt = (r, t, e) => {
  const s = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = s._$litPart$;
  if (i === void 0) {
    const o = (e == null ? void 0 : e.renderBefore) ?? null;
    s._$litPart$ = i = new T(t.insertBefore(C(), o), o, void 0, e ?? {});
  }
  return i._$AI(r), i;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ht = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: V }, Ot = (r = Ht, t, e) => {
...
var Mt = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, at = (r, t, e, s) => {
...
}, Dt = (r, t, e) => (kt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), Lt = (r, t, e) => {
  if (t.has(r))
...
let R = class extends P {
  constructor() {
    super(...arguments), this.subtitle = "This is a subtitle", Lt(this, j, "World");
  }
  render() {
    return Et`
      <div>
